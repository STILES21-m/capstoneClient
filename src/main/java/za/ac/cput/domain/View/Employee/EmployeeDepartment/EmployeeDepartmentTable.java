 ...
 * @author draybulambo
 */
public class EmployeeDepartmentTable extends javax.swing.JFrame {

    DefaultTableModel tableModel;
    public EmployeeDepartmentTable() {
        initComponents();
         createColum();
         pupolateEmployeeDepartment();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("LIST OF EMPLOYEE DEPARTMENT");
 ...
 public  void createColum(){
  ...
  public void pupolateEmployeeDepartment(){
    
          List EmployeeList =OkHttpClient.getAllEmployeeDepartment();
           List<za.ac.cput.domain.EmployeeDepartment> Employe_List =  EmployeeList;
           try{ 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeDepartmentTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeDepartmentTable().setVisible(true);
            }
        });
    }
