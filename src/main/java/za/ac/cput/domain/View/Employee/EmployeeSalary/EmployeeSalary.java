 ...
 */
package za.ac.cput.domain.View.Employee.EmployeeSalary;
...
public class EmployeeSalary extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("EmployeeSalary");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            OkHttpClient.saveEmployeeSalary(idEmp.getText(), jTextField1.getText());
            pupolateSalary();
            pupolateEmployee();
             idEmp.setText("");
              jTextField1.setText("");
    ...
    private void SalaryTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SalaryTableMouseClicked
           String id=tableModel1.getValueAt(SalaryTable.getSelectedRow(), 0).toString();
   ...
   public void pupolateEmployee(){
    ...
    public void pupolateSalary(){
    
           List SalaryList =OkHttpClient.getAllSalary();
           List<Salary> Employe_List =  SalaryList;
           try{ 
               
            SalaryTable.setModel(tableModel1);
            tableModel1 = (DefaultTableModel) SalaryTable.getModel();
    ...
    public  void createColumEmployee(){
     ...
     public  void createColumSalary(){
       
     
       tableModel1=  (DefaultTableModel) SalaryTable.getModel();
       tableModel1.addColumn("Salary Id");
       tableModel1.addColumn("Amount Earned");
