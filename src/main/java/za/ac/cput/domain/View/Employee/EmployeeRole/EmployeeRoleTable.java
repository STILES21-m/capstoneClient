 ...
 * @author draybulambo
 */
public class EmployeeRoleTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 30, 210, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            OkHttpClient.saveEmployeeRole(idEmp.getText(), jTextField1.getText());
            JOptionPane.showMessageDialog(this, "Saved");
             }
        } catch (IOException ex) {
            Logger.getLogger(EmployeeRoleTable.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void leavesTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_leavesTableMouseClicked
      
         String id=tableModel.getValueAt(leavesTable.getSelectedRow(), 0).toString();
   ...
   public void pupolateEmployee(){
    ...
    public void pupolateRole(){
    
           List LeavesList =OkHttpClient.getAllLeave();
           List<Leaves> Employe_List =  LeavesList;
           try{ 
            ...
            for (int i = 0; i < Employe_List .size(); i++) {
             ...
             Object[] objs = {
               ...
               Employe_List .get(i).getLeaveId(),
               Employe_List .get(i).getDaysOfLeave(),
    ...
    public  void createColumEmployee(){
     ...
     public  void createColumRole(){
       
     
       tableModel1=  (DefaultTableModel) leavesTable.getModel();
       tableModel1.addColumn("Role ID");
       tableModel1.addColumn("Role Name");
       tableModel1.addColumn("Role Description");
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeRoleTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeRoleTable().setVisible(true);
            }
        });
    }
