...
import za.ac.cput.domain.GenderView.GenderTable;
 ...
 * @author draybulambo
 */
public class DepartmentTable extends javax.swing.JFrame {
    ...
    public DepartmentTable() {
      ...
      public void pupolate(){
          ...
          List EmployeeList =OkHttpClient.getAllDepartment();
           List<Department> Employe_List =  EmployeeList;
           try{ 
            ...
            for (int i = 0; i < Employe_List .size(); i++) {
             ...
             Object[] objs = {
               ...
               Employe_List .get(i).getDeptId(),
               Employe_List .get(i).getDeptName(),
               Employe_List .get(i).getDeptDesc()
    ...
    private void initComponents() {
        ...
        jLabel2.setText("depart Id");
        jPanel5.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 90, 30));
        ...
        jPanel2.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, -1, -1));
        ...
        jPanel2.add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, -1, -1));
        ...
        jLabel6.setText("departDescr");
        jPanel7.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 90, 40));

        jPanel2.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 250, 40));

        jPanel10.setBackground(new java.awt.Color(255, 255, 255));
        jPanel10.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel10.add(txtDep, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 0, 160, 40));

        jLabel4.setBackground(new java.awt.Color(0, 0, 0));
        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 1, 13)); // NOI18N
        jLabel4.setText("departName");
        jPanel10.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 90, 40));

        jPanel2.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 250, 40));
        ...
        jLabel5.setText("LIST OF DEPARTMENT");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        OkHttpClient.deleteDepartmentById(txtID.getText());
          pupolate();
           txtID.setText("");
        txtDep.setText("");
        txtdesc.setText("");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
      ...
      }else if(txtDep.getText().isEmpty()){
       ...
       JOptionPane.showMessageDialog(this, "Description Name Can not be Empty");   
        ...
        String names=txtDep.getText();
        String descr=txtdesc.getText();
          try {
              OkHttpClient.updateDepartment(IDD, names, descr);
              pupolate();
              txtID.setText("");
              txtDep.setText("");
              txtdesc.setText("");
    ...
    public  void createColum(){
       ...
       tableModel=  (DefaultTableModel) jTable1.getModel();
       tableModel.addColumn("DeptId");
       tableModel.addColumn("DeptName");
       tableModel.addColumn("DeptDescr");
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepartmentTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepartmentTable().setVisible(true);
            }
        });
    }
