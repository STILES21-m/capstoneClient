 ...
 * @author draybulambo
 */
public class EmployeeContactTables extends javax.swing.JFrame {

    DefaultTableModel tableModel,tableModel1;
    public EmployeeContactTables() {
        initComponents();
      createColumEmployee();
        createColumGender();
        pupolateContact();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("EmployeeContact");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            OkHttpClient.saveEmployeeContact(idEmp.getText(), jTextField1.getText());
            pupolateContact();
            pupolateEmployee();
            idEmp.setText("");
            jTextField1.setText("");}
        } catch (IOException ex) {
            Logger.getLogger(EmployeeContactTables.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   public void pupolateEmployee(){
    ...
    public  void createColumEmployee(){
     ...
     public  void createColumGender(){
       ...
       tableModel1=  (DefaultTableModel) leavesTable.getModel();
       tableModel1.addColumn("Contactype Id");
       tableModel1.addColumn("Email");
       tableModel1.addColumn("Phone Number");;
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeContactTables.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeContactTables().setVisible(true);
            }
        });
    }
